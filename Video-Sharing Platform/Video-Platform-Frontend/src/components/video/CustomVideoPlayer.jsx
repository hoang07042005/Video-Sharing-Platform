        ...
        <div className="relative flex flex-col items-center gap-1">
          ...
          <div
            ...
            style={{
              animation:
                seekFlash === "left"
                  ? "yt-ripple 0.6s ease-out forwards"
                  : "none",
            }}
          />
                ...
                {activeSettingsTab === "main" && (
                  <div className="py-2">
                    {resolutions && resolutions.length > 0 && (
                      <button
                        type="button"
                        onClick={() => setActiveSettingsTab("resolution")}
                        className="w-full flex items-center justify-between px-4 py-3 hover:bg-white/10 transition-colors"
                      >
                        <span className="flex items-center gap-3 font-medium">
                          <Settings className="w-4 h-4 text-white/70" /> Chất
                          lượng
                        </span>
                        <span className="text-white/70 flex items-center gap-1">
                          {resolutions.find(
                            (r) => r.fileUrl === currentResolutionUrl,
                          )?.resolution || "Auto"}{" "}
                    ...
                    >
                      <span className="flex items-center gap-3 font-medium">
                        <Play className="w-4 h-4 text-white/70" /> Tốc độ phát
                      </span>
                      <span className="text-white/70 flex items-center gap-1">
                ...
                {activeSettingsTab === "resolution" && (
                  <div className="py-2">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 border-b border-white/10 hover:bg-white/10 transition-colors font-medium"
                    >
                          ...
                          return (
                            <button
                              ...
                              onClick={() => {
                                if (isLocked) {
                                  alert(
                                    `Chất lượng ${res.resolution} yêu cầu gói ${tier < 1 ? "PLUS" : "PREMIUM"} trở lên!`,
                                  );
                                  return;
                                }

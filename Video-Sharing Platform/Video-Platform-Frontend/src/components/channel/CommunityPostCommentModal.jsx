  ...
  const fetchReplies = async () => {
    try {
      ...
      const res = await axios.get(
        `/api/community/${postId}/comments?parentId=${comment.id}`,
      );
      setReplies(res.data);
      setShowReplies(true);
    } catch (err) {
    ...
    <div className={`relative mb-4 ${isReply ? "ml-10 z-0" : ""}`}>
      ...
      <div className={`flex gap-3 relative z-10`}>
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-white/90 mb-2 whitespace-pre-wrap">
            {comment.content}
          </p>
          ...
          <div className="flex items-center gap-4 text-xs text-white/50 font-semibold">
            ...
            >
              <ThumbsUp
                size={14}
                className={comment.isLikedByMe ? "fill-blue-500" : ""}
              />
              <span>
          ...
          {showReplies && (
            <div className="mt-4">
              {loadingReplies && (
                <div className="text-xs text-white/50 mb-2">Đang tải...</div>
              )}
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-[#1a1a1a] w-full max-w-2xl max-h-[100vh] flex flex-col overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between p-4 border-b border-white/10 shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 text-white/50 hover:text-white bg-white/5 rounded-full transition"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <div className="p-4 border-b border-white/10 bg-[#1a1a1a]">
            <div className="flex gap-3 items-start mb-2">
              <img
                src={
                  ...
                  `https://ui-avatars.com/api/?name=${post.authorName || post.channelName}`
                }
            ...
            <p className="text-sm text-white/90 whitespace-pre-wrap mb-3">
              {post.content}
            </p>
          ...
          >
            ...
            <img
              src={
                ...
                `https://ui-avatars.com/api/?name=${localStorage.getItem("handle") || "User"}`
              }
              alt="My Avatar"

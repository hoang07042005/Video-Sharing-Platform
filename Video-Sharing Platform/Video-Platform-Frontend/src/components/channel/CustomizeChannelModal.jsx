                ...
                <div className="w-full h-32 md:h-40 bg-[#2A2A2A] relative">
                  {formData.bannerUrl ? (
                    <img
                      ...
                      onError={(e) => {
                        e.target.src =
                          "https://via.placeholder.com/1200x400?text=L%E1%BB%97i+t%E1%BA%A3i+%E1%BA%A3nh";
                      }}
                    />
                  ) : (
                  ...
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border-4 border-[#0F0F0F] overflow-hidden bg-[#2A2A2A] shrink-0">
                    {formData.avatarUrl ? (
                      <img
                        ...
                        onError={(e) => {
                          e.target.src =
                            "https://via.placeholder.com/150?text=L%E1%BB%97i+%E1%BA%A3nh";
                        }}
                      />
                    ) : (

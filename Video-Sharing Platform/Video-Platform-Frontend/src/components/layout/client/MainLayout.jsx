...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-white">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#1F1F1F] rounded-2xl p-8 max-w-md w-full shadow-2xl border border-white/10 animate-fade-in relative">
            ...
            <p className="text-gray-400 text-center mb-8">
              Vui lòng cập nhật thông tin tài khoản của bạn để có trải nghiệm
              tốt nhất trên nền tảng của chúng tôi.
            </p>
            <button
      ...
      <main
        className={`pt-12 transition-all duration-300 ${isSidebarOpen ? "pl-56" : "pl-0"}`}
      >

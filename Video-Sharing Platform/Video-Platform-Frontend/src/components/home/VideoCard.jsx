  ...
  return (
    ...
    >
        ...
        {isOwner && (
          <div className="absolute top-2 right-2 flex gap-2 opacity-100 transition-opacity">
            <button
              ...
              className="bg-black/80 hover:bg-[#FF4E00] text-white p-1.5 rounded-full transition-colors"
            >
            ...
            <button
              ...
              className="bg-black/80 hover:bg-red-600 text-white p-1.5 rounded-full transition-colors"
            >
      ...
      <div className="flex gap-3">
        <Link
          to={`/c/${video.handle}`}
          className="w-10 h-10 rounded-full overflow-hidden shrink-0 bg-[#2A2A2A] block"
        >
          <img
            src={video.avatar}

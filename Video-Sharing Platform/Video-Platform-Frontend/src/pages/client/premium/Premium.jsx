...
import { Check, X, Ban, Download, Tv, Headphones, Crown, Play, Star } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-white pb-20 font-sans overflow-x-hidden">
      ...
      >
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="max-w-[600px]">
            <h2 className="text-[#E91E63] font-bold text-sm tracking-widest uppercase mb-4">Nâng cấp tài khoản</h2>
            ...
            <p className="text-gray-400 text-base md:text-lg mb-8 max-w-[500px]">
              Chọn gói phù hợp để tận hưởng kho nội dung khổng lồ, chất lượng cao và nhiều tính năng độc quyền.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-2 bg-[#1A1A1A] border border-white/10 rounded-xl px-4 py-3">
                ...
                <div>
                  <p className="text-white text-sm font-bold">Không quảng cáo</p>
                  <p className="text-gray-500 text-[10px]">Xem video liền mạch</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 bg-[#1A1A1A] border border-white/10 rounded-xl px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-[10px]">Xem mọi lúc, mọi nơi</p>
                </div>
              </div>
      ...
      <div className="max-w-[1500px] mx-auto px-4 md:px-4 py-4 relative z-10 mt-5">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-white mb-8">Chọn gói phù hợp với bạn</h2>
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-[#1A1A1A] p-1 rounded-full inline-flex border border-white/10">
            ...
            >
              Thanh toán hàng năm
              <span className="bg-red-500 text-white text-[10px] px-2 py-0.5 rounded-full">-20%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          {/* Free Card */}
          <div className={`bg-[#111111] rounded-3xl p-8 border border-white/5 flex flex-col h-full hover:border-white/20 transition-all ${getPlanStatus('Free', isYearly) === 'downgrade' ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-white mb-1">FREE</h3>
              <p className="text-gray-500 text-xs">Dành cho người mới bắt đầu</p>
            </div>
            <div className="text-center mb-6">
              <span className="text-4xl font-bold text-white">Miễn phí</span>
              <span className="text-gray-500 text-sm block mt-2">Không giới hạn thời gian</span>
            </div>
            <button disabled className="w-full py-3 rounded-xl bg-[#222222] text-gray-300 font-bold mb-8 transition-colors">
          ...
          {/* Premium Card */}
          <div className={`bg-gradient-to-b from-[#3A1414] via-[#2A111A] to-[#111111] rounded-3xl p-8 border border-[#FF9800]/50 shadow-[0_0_30px_rgba(255,152,0,0.15)] flex flex-col h-full hover:shadow-[0_0_40px_rgba(255,152,0,0.3)] transition-all relative ${getPlanStatus('Premium', isYearly) === 'downgrade' ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
            ...
            <div className="text-center mb-6 mt-2">
              ...
              <p className="text-gray-400 text-xs">Trải nghiệm đỉnh cao, không giới hạn</p>
            </div>
            <div className="text-center mb-6">
              <span className="text-4xl font-bold text-white">{isYearly ? '1.238.000' : '129.000'}</span>
              <span className="text-xl text-white">đ</span>
              <span className="text-gray-400 text-sm">{isYearly ? ' / năm' : ' / tháng'}</span>
            </div>
            <button 
              onClick={() => handlePayment('Premium', isYearly ? 1238000 : 129000)}
              disabled={isLoading || getPlanStatus('Premium', isYearly) !== 'upgrade'}
            ...
            >
              {getPlanStatus('Premium', isYearly) === 'current' ? (premiumUntil ? `HSD: ${premiumUntil.toLocaleDateString('vi-VN')}` : 'Gói hiện tại') : (getPlanStatus('Premium', isYearly) === 'upgrade' && currentPlan === 'Premium') ? 'Nâng cấp lên Năm' : 'Dùng thử 7 ngày'}
            </button>
            <div className="space-y-4 flex-1">
            ...
            <div className="mt-8 pt-4 border-t border-white/5 flex items-center gap-3">
              ...
              <p className="text-gray-400 text-xs leading-snug">Trải nghiệm tốt nhất cho người yêu video</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1000px] mx-auto px-4 md:px-8 py-16">
        <h2 className="text-2xl font-bold text-center text-white mb-12">Vì sao nên nâng cấp lên <span className="text-[#FF9800]">Premium?</span></h2>
        
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
          <FeatureIcon icon={<Ban />} title="Không quảng cáo" desc="Tận hưởng video mượt mà, không bị gián đoạn" color="text-red-500" />
          <FeatureIcon icon={<Download />} title="Tải video offline" desc="Lưu video yêu thích và xem mọi lúc, mọi nơi" color="text-purple-400" />
          <FeatureIcon icon={<div className="font-black text-xl">4K</div>} title="Chất lượng vượt trội" desc="Hình ảnh sắc nét đến từng chi tiết" color="text-pink-500" />
          <FeatureIcon icon={<Tv />} title="Đa thiết bị" desc="Xem trên TV, điện thoại, máy tính, tablet" color="text-blue-400" />
          <FeatureIcon icon={<Headphones />} title="Hỗ trợ ưu tiên" desc="Được hỗ trợ nhanh chóng mọi lúc, mọi nơi" color="text-green-400" />
        </div>
      </div>
      ...
      <div className="max-w-[1100px] mx-auto px-4 md:px-8 py-12">
        <div className="bg-gradient-to-r from-[#4A148C] via-[#880E4F] to-[#E65100] rounded-3xl p-8 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
           ...
           <div className="flex-1 text-center md:text-left relative z-10 md:ml-20">
             <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-3">Nâng cấp ngay – Trải <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-pink-300">nghiệm ngay!</span></h2>
             <p className="text-gray-200 text-sm md:text-base max-w-[500px] mx-auto md:mx-0">Hàng triệu video hấp dẫn đang chờ bạn khám phá cùng VideoX Premium.</p>
           </div>
           ...
           <div className="relative z-10">
             ...
             >
               ...
               {getPlanStatus('Premium', isYearly) === 'current' ? (premiumUntil ? `Đã kích hoạt (HSD: ${premiumUntil.toLocaleDateString('vi-VN')})` : 'Đã kích hoạt') : (getPlanStatus('Premium', isYearly) === 'upgrade' && currentPlan === 'Premium') ? 'Nâng cấp lên Năm' : 'Nâng cấp ngay'}
             </button>
           </div>
        </div>
      </div>
...
function FeatureItem({ text, active, color = "text-green-500" }) {
  return (
    <div className="flex items-start gap-3">
      ...
      <span className={active ? "text-gray-300 text-[13px]" : "text-gray-600 text-[13px]"}>{text}</span>
    </div>
  );
}

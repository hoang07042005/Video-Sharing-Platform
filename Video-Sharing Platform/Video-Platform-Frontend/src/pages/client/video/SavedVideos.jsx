    ...
    <div className="flex-1 overflow-y-auto bg-[#0A0A0A] text-white font-sans min-h-screen">
      ...
      <div className="px-8 pt-8 pb-3">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h1 className="text-[26px] font-extrabold text-white mb-0.5 tracking-tight">
              Danh sách Xem sau
            </h1>
            <p className="text-gray-400 text-[13px]">
              Lưu lại những nội dung yêu thích để thưởng thức bất cứ khi nào bạn
              có thời gian rảnh. Hoàn toàn riêng tư và tiện lợi.
            </p>
          </div>
        </div>
          ...
          <div className="bg-[#121212] border border-white/5 rounded-2xl p-6 sticky top-6 shadow-xl shadow-black/40">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-[13px] leading-relaxed">
                Các video bạn xem sau sẽ ở đây
                <br />
                để xem bất cứ khi nào.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-5 mb-8 px-2">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-gray-500 text-[13px] mt-1.5">
                    Video ngắn
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                onClick={() =>
                  filteredVideos[0] &&
                  navigate(
                    filteredVideos[0].isShort
                      ? "/shorts"
                      : `/watch/${filteredVideos[0].id}`,
                  )
                }
          ...
          {error ? (
            ...
            <div className="flex flex-col gap-2">
              {filteredVideos.map((video, index) => {
                ...
                const displayTags =
                  tags.length > 0 ? tags : ["#nhactre", "#top50", "#haynhat"];

...
const LikedVideos = () => {
  ...
  const formatViews = (views) => {
    if (!views) return "0";
    if (views >= 1000000)
      return `${(views / 1000000).toFixed(1).replace(".", ",")} Tr`;
    if (views >= 1000)
      return `${(views / 1000).toFixed(1).replace(".", ",")} N`;
    return String(views);
  };
      ...
      <div className="max-w-[1500px] mx-auto p-6">
          ...
          <div className="relative z-10 w-full">
            <div className="flex items-center gap-4 mb-4">
              <div
                ...
                style={{
                  background: "linear-gradient(135deg,#9C27B0,#FF4E00)",
                }}
              >
              ...
              <div>
                ...
                <p className="text-gray-300 w-[650px] text-[18px] mt-1">
                  Nơi lưu giữ toàn bộ video dài và Shorts bạn từng yêu thích. Dễ
                  dàng xem lại các nội dung tâm đắc, chia sẻ với bạn bè hoặc
                  khám phá thêm các gợi ý tương tự dựa trên gu của bạn.
                </p>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            <button className="px-3 py-2 bg-[#161616] rounded-full text-sm text-gray-300">
              Mới nhất
            </button>
            <div className="px-3 py-2 bg-[#161616] rounded-full text-sm text-gray-300">
              Danh sách lưới
            </div>
          </div>
        </div>

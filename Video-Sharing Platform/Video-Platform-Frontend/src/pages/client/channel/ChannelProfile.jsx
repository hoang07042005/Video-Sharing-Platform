...
import { Loader2, Bell, CheckCircle2, Share2, Search, Star, Users, Link as LinkIcon, X, Mail, MonitorPlay, Globe, Info, PlaySquare, TrendingUp, Flag, Pencil, Home } from 'lucide-react';
        ...
        <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 md:px-8 pt-32 md:pt-40 pb-0 flex flex-col">
          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-6 overflow-x-auto scrollbar-hide w-full md:w-auto">
              ...
              <button
                className="pb-3 whitespace-nowrap transition-colors text-sm md:text-base font-semibold text-gray-400 hover:text-white"
              >
                Shorts
              </button>
              <button
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                      {playlists.map(playlist => (
                        <div key={playlist.id} className="group cursor-pointer">
                          ...
                          <h4 className="text-white font-semibold text-sm line-clamp-2 leading-snug">{playlist.title}</h4>

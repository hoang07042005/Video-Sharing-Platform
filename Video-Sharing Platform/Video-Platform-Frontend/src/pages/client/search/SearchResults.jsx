        ...
        {loading ? (
              ...
              <div>
                ...
                <div className="flex flex-col gap-4">
                  {channels.map((channel) => (
                    <div
                      key={channel.id}
                      className="flex flex-col sm:flex-row items-center sm:items-start gap-6 group border-b border-white/5 pb-4"
                    >
                      <Link
                        to={`/c/${channel.handle}`}
                        className="shrink-0 w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden ml-0 sm:ml-10"
                      >
                        <img
                          src={
                            channel.avatarUrl ||
                      ...
                      <div className="flex flex-col items-center sm:items-start flex-1 mt-2 sm:mt-6">
                        <Link
                          to={`/c/${channel.handle}`}
                          className="text-lg sm:text-xl font-medium text-white group-hover:text-gray-300 transition-colors flex items-center gap-2"
                        >
                          {channel.channelName}
                          {channel.isVerified && (
                ...
                >
                  {shorts.map((short) => (
                    <div
                      ...
                      className="shrink-0 w-[160px] sm:w-[200px] cursor-pointer group snap-start"
                    >
                      ...
                      <div className="flex flex-col py-1 md:py-2 min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2 md:mb-3">
                          ...
                          <Link
                            to={`/c/${video.channelHandle}`}
                            onClick={(e) => e.stopPropagation()}
                            className="text-gray-400 text-[13px] hover:text-white transition-colors flex items-center gap-1"
                          >
                            {video.channelName}
          ...
          <div className="flex flex-col items-center justify-center py-32">
            ...
            <p className="text-gray-400">
              Hãy thử các từ khóa khác hoặc xóa bộ lọc tìm kiếm.
            </p>
          </div>
        )}
      </div>

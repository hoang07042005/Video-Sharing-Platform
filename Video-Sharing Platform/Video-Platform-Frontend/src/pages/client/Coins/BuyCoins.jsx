...
const PACKAGES = [
  {
    ...
    color: "text-blue-400",
    bgGradient: "from-[#111A2B] to-[#111111]",
  ...
  },
  {
    ...
    bgGradient: "from-[#112B1A] to-[#111111]",
    border: "border-green-500/30",
    btnGradient: "from-green-600 to-emerald-500",
  ...
  },
  {
    ...
    color: "text-[#FF9800]",
    bgGradient: "from-[#3A2214] to-[#111111]",
    border: "border-[#FF9800]/50",
    btnGradient: "from-[#FF5722] to-[#FF9800]",
    shadow: "shadow-[0_0_20px_rgba(255,152,0,0.4)]",
  },
  {
    id: 4,
    amount: 100000,
    ...
    color: "text-[#E91E63]",
    bgGradient: "from-[#3A1428] to-[#111111]",
    border: "border-[#E91E63]/30",
    btnGradient: "from-[#E91E63] to-pink-500",
    shadow: "shadow-[0_0_15px_rgba(233,30,99,0.3)]",
  },
  {
    id: 5,
    amount: 500000,
    ...
    bgGradient: "from-[#1E112B] to-[#111111]",
    border: "border-[#9C27B0]/30",
    btnGradient: "from-[#7E57C2] to-[#5E35B1]",
    shadow: "shadow-[0_0_15px_rgba(156,39,176,0.3)]",
  },
];
    ...
    <div className="min-h-screen bg-[#0A0A0B] pb-24 pt-12">
      ...
      <div className="max-w-[800px] mx-auto px-4 text-center mb-16 mt-8">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight flex items-center justify-center gap-3">
          ...
          <span className="bg-gradient-to-r from-[#FF5722] to-[#E91E63] bg-clip-text text-transparent">
            Nạp Xu
          </span>
        </h1>
        <p className="text-gray-400 text-lg md:text-xl">
          Nạp Xu để ủng hộ nhà sáng tạo, tặng quà livestream và trải nghiệm các
          tính năng độc quyền trên hệ thống.
        </p>
      </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-white flex items-baseline gap-2">
                  ...
                  <span className="text-xl text-[#FF5722]">Xu</span>
                </div>
              </div>
            </div>
          ...
          {PACKAGES.map((pkg) => (
            ...
            >
              ...
              <div className="text-center mb-6 mt-2">
                <h3
                  className={`text-lg font-bold ${pkg.color} mb-1 flex items-center justify-center gap-2`}
                >
                  {pkg.icon}
                  {pkg.title}
                </h3>

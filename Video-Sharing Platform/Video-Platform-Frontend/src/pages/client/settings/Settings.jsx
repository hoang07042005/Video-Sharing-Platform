  ...
  return (
    <div className="flex items-center justify-between gap-4 py-4 px-5 rounded-xl hover:bg-white/5 transition-colors group">
      <div className="flex items-center gap-4 flex-1 min-w-0">
        <div
          className={`w-9 h-9 rounded-xl flex items-center justify-center bg-white/5 shrink-0 ${iconColor}`}
        >
              ...
              <div className="space-y-1">
                {tabs.map((tab) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${isActive ? "bg-white/10" : "bg-transparent group-hover:bg-white/5"}`}
                      >
                        <tab.icon
                          className={`w-4.5 h-4.5 ${isActive ? tab.color : "text-gray-500 group-hover:" + tab.color}`}
                        />
                      </div>
                      <span
                        className={`text-sm font-medium flex-1 text-left ${isActive ? "text-white" : "text-gray-400 group-hover:text-gray-300"}`}
                      >
                        {tab.label}
                      </span>
                      {isActive && (
          ...
          <div className="flex-1 min-w-0">
            ...
            {activeTab === "account" && (
              <div className="bg-[#161616] border border-white/8 rounded-2xl overflow-hidden shadow-xl p-6 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {profileMsg.text && (
                  <div
                    className={`mb-6 p-4 rounded-xl text-sm border flex items-center gap-3 ${profileMsg.type === "success" ? "bg-green-500/10 border-green-500/50 text-green-500" : "bg-red-500/10 border-red-500/50 text-red-500"}`}
                  >
                    {profileMsg.text}
                  </div>
                )}
              ...
              <div className="bg-[#161616] border border-white/8 rounded-2xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="p-6 md:p-8 border-b border-white/10 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Quản lý các nút chức năng trên trang kênh của bạn
                    </p>
                  </div>
                </div>
                <div className="p-2">
                  ...
                  >
                    <Toggle
                      ...
                      onChange={(val) =>
                        updateSetting("showCommunityButton", val)
                      }
                    />
                  </SettingItem>
                </div>
              ...
              <div className="bg-[#161616] border border-white/8 rounded-2xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="p-6 md:p-8 border-b border-white/10 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Thay đổi cách ứng dụng hiển thị
                    </p>
                  </div>
                </div>
                <div className="p-2">
                  ...
                  >
                    <span className="text-xs font-medium text-green-400 bg-green-400/10 border border-green-400/20 px-3 py-1.5 rounded-full">
                      Đang bật
                    </span>
                  </SettingItem>
                </div>
            ...
            {activeTab === "security" && (
              <div className="bg-[#161616] border border-white/8 rounded-2xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500 p-6 md:p-8">
                ...
                <div className="bg-[#202020] border border-white/5 rounded-xl p-6">
                  ...
                  {pwdMsg.text && (
                    <div
                      className={`mb-6 p-4 rounded-xl text-sm border flex items-center gap-3 ${pwdMsg.type === "success" ? "bg-green-500/10 border-green-500/50 text-green-500" : "bg-red-500/10 border-red-500/50 text-red-500"}`}
                    >
                      {pwdMsg.text}
                    </div>
                  )}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onPaste={(e) => {
                          ...
                          setPwdMsg({
                            type: "error",
                            text: "Vui lòng tự nhập lại mật khẩu, không sử dụng copy-paste.",
                          });
                        }}
                      />
                    </div>
                ...
                <div className="p-2">
                  ...
                  <div className="p-6 text-center">
                    ...
                    <p className="text-xs text-gray-600">
                      Được thiết kế với trải nghiệm tốt nhất cho nhà sáng tạo và
                      khán giả.
                    </p>
                  </div>
                </div>

...
export default function StudioRevenue() {
  ...
  const BANK_OPTIONS = [
    {
      name: "Ví MoMo",
      value: "MoMo",
      logo: "/public/images/bank-logos/Icon-Momo.png",
    },
    {
      name: "Ví ZaloPay",
      value: "ZaloPay",
      logo: "/public/images/bank-logos/Icon-ZaloPay.png",
    },
    {
      name: "Ví VNPay",
      value: "VNPay",
      logo: "/public/images/bank-logos/Icon-VnPay.png",
    },
    {
      name: "Vietcombank",
      value: "Vietcombank",
      logo: "/public/images/bank-logos/Icon-Vietcombank.png",
    },
    {
      name: "Techcombank",
      value: "Techcombank",
      logo: "/public/images/bank-logos/Icon-Techcombank-TCB.png",
    },
    {
      name: "MB Bank",
      value: "MB Bank",
      logo: "/public/images/bank-logos/Icon-MB-Bank-MBB.png",
    },
    {
      name: "VietinBank",
      value: "VietinBank",
      logo: "/public/images/bank-logos/Icon-VietinBank-CTG.png",
    },
    {
      name: "BIDV",
      value: "BIDV",
      logo: "/public/images/bank-logos/Icon-BIDV.png",
    },
    {
      name: "Agribank",
      value: "Agribank",
      logo: "/public/images/bank-logos/Icon-Agribank.png",
    },
    {
      name: "TPBank",
      value: "TPBank",
      logo: "/public/images/bank-logos/Icon-TPBank.png",
    },
    {
      name: "VPBank",
      value: "VPBank",
      logo: "/public/images/bank-logos/Icon-VPBank.png",
    },
    {
      name: "Sacombank",
      value: "Sacombank",
      logo: "/public/images/bank-logos/Icon-Sacombank.png",
    },
  ];
  ...
  const getRemainingVirtualBuckets = () => {
    if (!stats || !withdrawals)
      return { giftVND: 0, donateVND: 0, membershipVND: 0 };

    let giftCoins = Math.floor(stats.totalGiftedCoins * (1 - FEE_COIN_GIFT));
    let donateCoins = Math.floor(
      (stats.totalDonatedMoney / COIN_RATE) * (1 - FEE_DONATE),
    );
  ...
  const getActualTotalAvailableVND = () => {
    ...
    const currentOwnCoinsVND =
      (profile?.coins || 0) * COIN_RATE * (1 - FEE_COIN_OWN);
  ...
  const handleSubmit = async (e) => {
    ...
    const amountToWithdraw = parseInt(
      formData.amountVnd.replace(/[^0-9]/g, ""),
    );
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "Lỗi khi gửi yêu cầu rút tiền",
      );
    } finally {
      setSubmitting(false);
    }
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      default:
        return (
          <span className="px-2 py-1 text-xs font-medium rounded-full bg-gray-500/10 text-gray-400">
            {status}
          </span>
        );
    }
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm text-gray-400">
            Quản lý số dư và tạo lệnh rút tiền về tài khoản ngân hàng
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#141418] border border-white/5 rounded-2xl p-6 flex flex-col justify-between">
          ...
          <div className="mt-8 pt-4 border-t border-white/5 relative">
            <div className="text-xs text-gray-400 mb-1">
              Xu được nhận (Tặng quà):
            </div>
            <div className="text-purple-400 font-medium text-sm">
              {getRemainingVirtualBuckets().rawGiftCoins.toLocaleString()} Xu
            </div>
            {/* Coins decoration */}
        ...
        <div className="bg-[#141418] border border-white/5 rounded-2xl p-6 flex flex-col justify-between overflow-hidden relative">
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-gray-300 font-medium">
                Tiền Donate nhận được
              </h3>
            </div>
            <div className="flex items-baseline gap-2 mt-4">
              <span className="text-4xl font-bold text-white">
                {getRemainingVirtualBuckets().rawDonateVND.toLocaleString()}
              </span>
          ...
          <div className="absolute bottom-0 left-0 w-full h-24 opacity-30 pointer-events-none">
            <svg
              ...
              className="w-full h-full text-green-500 fill-transparent stroke-current stroke-2"
            >
        ...
        <div className="bg-[#141418] border border-white/5 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex items-baseline gap-2 mt-4">
              <span className="text-4xl font-bold text-white">
                {getActualTotalAvailableVND().toLocaleString()}
              </span>
              <span className="text-gray-400 font-medium">VNĐ</span>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="text-gray-300 font-medium">
                  ...
                  VNĐ <span className="text-red-400 ml-1">(-5%)</span>
                </div>
              </div>
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                ...
                <div className="text-gray-300 font-medium">
                  {getRemainingVirtualBuckets().giftVND.toLocaleString()} VNĐ{" "}
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="text-gray-300 font-medium">
                  {getRemainingVirtualBuckets().donateVND.toLocaleString()} VNĐ{" "}
                  <span className="text-red-400 ml-1">(-10%)</span>
                </div>
              </div>
              <div className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-8 text-sm text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Tỷ giá quy đổi mặc định: <b>1 Xu = 100 VNĐ</b>
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-4 h-4 rounded-full bg-purple-500 flex items-center justify-center mt-0.5 shrink-0">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  Nếu lệnh bị từ chối, số Xu sẽ được hoàn lại vào tài khoản.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-4 h-4 rounded-full bg-purple-500 flex items-center justify-center mt-0.5 shrink-0">
                ...
                <span>
                  Thời gian xử lý giao dịch thường từ 1 - 3 ngày làm việc.
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-gradient-to-r from-[#ffe5e5] to-[#fff4e5] rounded-2xl p-8 relative overflow-hidden flex items-center">
          ...
          <div className="relative z-10 max-w-[60%]">
            ...
            <p className="text-gray-700 w-50 text-sm mb-6 leading-relaxed">
              Nhận nhiều quà tặng từ người xem để tăng thu nhập và xây dựng cộng
              đồng mạnh mẽ.
            </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <form
            ...
            className="bg-[#141418] border border-white/5 rounded-2xl p-6 sticky top-6"
          >
            <h3 className="text-white font-semibold mb-6 flex items-center gap-2">
              <svg
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-2 text-xs text-gray-400">
                  ...
                  <span className="text-orange-400 font-semibold">
                    {getActualTotalAvailableVND().toLocaleString()} VNĐ
                  </span>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <svg
                    className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${isBankDropdownOpen ? "rotate-180" : ""}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >

  ...
  const handleVideoSelect = (e) => {
    ...
    if (file) {
      ...
      if (file.size > maxSize) {
        ...
        setError(
          `File quá lớn. Giới hạn của gói hiện tại là ${sizeMsg}. Vui lòng nâng cấp gói để tải lên file lớn hơn.`,
        );
        return;
      }
        ...
        <div>
          ...
          <p className="text-gray-400 text-xs mb-3">
            ...
            {editingVideo
              ...
              : `Định dạng hỗ trợ: MP4, MOV, AVI, WMV, FLV, WebM. Kích thước tối đa: ${tier === 2 ? "10GB" : tier === 1 ? "2GB" : "100MB"}.`}
          </p>
          <input
            type="file"
            accept="video/*"

...
import { 
  BarChart2, Calendar, Download, AlertTriangle, Flag, ShieldAlert, 
  ShieldCheck, Filter, CheckCircle2, XCircle, Eye, MoreVertical,
  Search, ChevronLeft, ChevronRight, Activity, ArrowUpRight, ArrowDownRight, Loader2
} from 'lucide-react';
import { 
  ...
  return (
    <div className="pb-20 max-w-[1600px] mx-auto text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 mb-6">
        {/* Card 1 */}
        <div className="bg-[#15171f] rounded-2xl border border-white/5 overflow-hidden flex flex-col justify-between pt-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        {/* Trend Chart */}
        <div className="bg-[#15171f] p-5 rounded-2xl border border-white/5 lg:col-span-2 h-[420px] flex flex-col">
        ...
        {/* Action Priority */}
        <div className="bg-[#15171f] p-6 rounded-2xl border border-white/5 lg:col-span-1 h-[420px] flex flex-col">

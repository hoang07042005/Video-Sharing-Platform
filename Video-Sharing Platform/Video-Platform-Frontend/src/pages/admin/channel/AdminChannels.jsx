  ...
  return (
    <div className="p-6 md:p-8 max-w-[1600px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-4">
        {/* Total Channels */}
        <div className="bg-[#0F0F0F] border border-white/5 p-5 rounded-2xl flex flex-col justify-between h-[120px] relative overflow-hidden">
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="flex-1 space-y-4 overflow-hidden">
          {/* Filters and Search */}
          <div className="bg-[#0F0F0F] border border-white/5 rounded-2xl p-4 flex flex-col md:flex-row gap-4 justify-between items-center">
            <div className="flex bg-[#0F0F0F] rounded-lg p-1 w-full md:w-auto">
              <button
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <div className="relative flex-1 md:w-80">
                ...
                <input
                  ...
                  className="w-full bg-[#0F0F13] border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:border-purple-500 transition-colors"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0F0F0F] border border-white/5 rounded-2xl overflow-hidden">
            <div className="overflow-x-auto min-h-[400px]">
              <table className="w-full text-left text-sm text-gray-400">
                <thead className="text-[11px] uppercase bg-[#0F0F0F] border-b border-white/5 text-gray-400 tracking-wider">
                  <tr>
            ...
            {!loading && totalPages > 1 && (
              <div className="px-6 py-4 border-t border-white/5 bg-[#141418] flex items-center justify-between">

        ...
        <div className="bg-[#141418] border border-white/5 rounded-xl p-5 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="flex items-start justify-between relative z-10">
            <div>
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold text-white">
                  {stats.currentMonthRevenue.toLocaleString(undefined, {
                    maximumFractionDigits: 0,
                  })}
                </span>
                <span className="text-xs text-gray-500 font-medium">VNĐ</span>
          ...
          <div className="mt-6 flex items-center gap-1.5 relative z-10">
            <span
              className={`flex items-center text-xs font-medium ${stats.percentChange >= 0 ? "text-green-400" : "text-red-400"}`}
            >
        ...
        <div className="bg-[#141418] border border-white/5 rounded-xl p-5 flex flex-col justify-between relative overflow-hidden">
          <div className="flex items-start justify-between relative z-10">
            <div>
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold text-white">
                  {stats.averageRevenuePerWithdrawal.toLocaleString(undefined, {
                    maximumFractionDigits: 0,
                  })}
                </span>
                <span className="text-xs text-gray-500 font-medium">VNĐ</span>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <RechartsTooltip
                  ...
                  itemStyle={{ color: "#fff" }}
                  formatter={(value) =>
                    `${Number(value).toLocaleString(undefined, { maximumFractionDigits: 0 })} VNĐ`
                  }
                />
                <Legend
      ...
      <div className="bg-[#141418] border border-white/5 rounded-xl overflow-hidden">
        <div className="p-5 border-b border-white/5">
          ...
          <p className="text-xs text-gray-400 mt-1">
            Chi tiết các khoản phí thu được từ các lệnh rút tiền hoàn tất
          </p>
        </div>
                  ...
                  >
                    ...
                    <td className="px-5 py-3 align-middle">
                      <div className="flex items-center gap-3">
                        <img
                          src={
                            item.streamerAvatar ||
                            `https://api.dicebear.com/7.x/avataaars/svg?seed=${item.streamerEmail}`
                          }
                          alt=""
                    ...
                    <td className="px-5 py-3 align-middle text-right">
                      <div className="font-medium text-gray-300">
                        {item.amountReceived.toLocaleString(undefined, {
                          maximumFractionDigits: 0,
                        })}
                      </div>
                    </td>
                    <td className="px-5 py-3 align-middle text-right bg-green-500/5">
                      <div className="font-bold text-green-400">
                        +
                        {item.platformFee.toLocaleString(undefined, {
                          maximumFractionDigits: 0,
                        })}
                      </div>
                    </td>

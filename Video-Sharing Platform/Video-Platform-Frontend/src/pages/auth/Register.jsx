...
import { Mail, Lock, User, AtSign, Tv, Phone, Loader2, Eye, EyeOff, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full md:w-1/2 lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 relative z-10 overflow-y-auto">
        ...
        <div className="w-full max-w-md mx-auto md:mx-0">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  type="text" name="fullName" placeholder="Nguyễn Văn A" required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    type="email" name="email" placeholder="nhap@email.com" required
                    className="w-full bg-[#202020] border border-transparent rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#FF3B30]/50 focus:bg-[#2A2A2A] transition-all"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    type="tel" name="phoneNumber" placeholder="0987654321" required
                    className="w-full bg-[#202020] border border-transparent rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#FF3B30]/50 focus:bg-[#2A2A2A] transition-all"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    type="text" name="channelName" placeholder="Kênh của tôi" required
                    className="w-full bg-[#202020] border border-transparent rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#FF3B30]/50 focus:bg-[#2A2A2A] transition-all"
              ...
              <div className="space-y-1.5">
                <label className="text-xs text-gray-400">Tên định danh (Handle)</label>
                <div className="relative">
                  <AtSign className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 w-5 h-5" />
                  <input 
                    type="text" name="handle" placeholder="@user" required
                    className="w-full bg-[#202020] border border-transparent rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#FF3B30]/50 focus:bg-[#2A2A2A] transition-all"
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <span className="text-xs text-gray-600">hoặc đăng ký với</span>
            <div className="flex-1 h-px bg-white/5"></div>
          </div>

          <div className="grid grid-cols-2 gap-4 mt-6">
            <button className="flex items-center justify-center gap-3 py-2 bg-transparent border border-white/10 rounded-xl hover:bg-white/5 transition-colors cursor-pointer">
      ...
      <div className="hidden md:block w-1/2 lg:w-[55%] relative overflow-hidden bg-black">
        ...
        <div className="absolute top-10 right-10 z-20 flex gap-4">
          <div className="bg-black/30 backdrop-blur-md border border-white/10 px-5 py-2.5 rounded-xl text-center">
            <div className="text-white font-bold text-xl leading-none mb-1">PRO</div>
            <div className="text-[10px] text-gray-300 tracking-widest uppercase font-medium">Creator</div>
          </div>
          <div className="bg-black/30 backdrop-blur-md border border-white/10 px-5 py-2.5 rounded-xl text-center">
            <div className="text-white font-bold text-xl leading-none mb-1">UNLTD</div>
            <div className="text-[10px] text-gray-300 tracking-widest uppercase font-medium">Access</div>
          </div>
        </div>
        ...
        <div className="absolute bottom-16 left-12 right-12 z-20">
          <div className="bg-black/30 backdrop-blur-xl border border-white/10 p-10 rounded-3xl shadow-2xl">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-white text-xs font-bold tracking-widest uppercase">Join Us</span>
            </div>
            ...
            <p className="text-gray-300 text-sm lg:text-base max-w-md leading-relaxed font-light">
              Gia nhập mạng lưới hàng triệu nhà sáng tạo nội dung hàng đầu. Chia sẻ video, kết nối cộng đồng và xây dựng thương hiệu cá nhân của riêng bạn ngay hôm nay.
            </p>
          </div>
        </div>
      </div>
